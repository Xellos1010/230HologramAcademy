...
class SurfaceEntry
{
    ...
    public const float c_Extents = 500.0f;
}

public class SMExample : MonoBehaviour
{
    ...
    // Delay calling the SurfaceObserver.Update to often
    float delayCallSurfaceObserver = 0;
    ...
    void Update()
    {
        ...
        if (m_lastUpdateTime + delayCallSurfaceObserver < Time.realtimeSinceStartup)
        {
